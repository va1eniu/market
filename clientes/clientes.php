...
<body>
  <div class="contenedor">
    ...
    <div class="parte-izquierda">
      ...
      <div class="perfil">
        <h3 style="margin-bottom: 2rem;">Camper</h3>
        <img src="images/Diseño sin título.png" alt="" class="imagenPerfil">
        <h3>su puta madre</h3>
      </div>
      <div class="menus">
        <a href="../home/market.php" style="display: flex;gap:2px;">
        ...
        <a href="../clientes/clientes.php" style="display: flex;gap:1px;">
          ...
          <h3 style="margin: 0px;font-weight: 800;"></h3>
        </a>
      ...
      <div class="menuTabla contenedor2">
        <table class="table table-custom ">
          ...
          <tr>
            ...
            <td> 
              <a class= "btn btn-danger" href="borrarClientes.php?id=<?=$val['id']?>&req=delete">Borrar</a> 
              <a class= "btn btn-warning" href="actualizarClientes.php?id=<?=$val['id']?> ">Editar</a> 
            </td>
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="registrarClientes.php" method="post">
              <div class="mb-1 col-12">
                <label for="celular" class="form-label">Nombre</label>
                <input 
                  type="text"
                  id="celular"
                  name="celular"
              ...
              <div class="mb-1 col-12">
                <label for="compañia" class="form-label">pequeña compañia</label>
                <input 
                  type="text"
                  id="compañia"
                  name="compañia"
