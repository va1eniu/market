      ...
      <div class="menuTabla contenedor2">
        <table class="table table-custom ">
          ...
          <tr>
            ...
            <td> 
              <a class= "btn btn-danger" href="borrarCategorias.php?id=<?=$val['id']?>&req=delete">Borrar</a> 
              <a class= "btn btn-warning" href="actualizarCategorias.php?id=<?=$val['id']?> ">Editar</a> 
            </td>
        ...
        <div class="modal-content" >
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="registrarCate.php" method="post">
              ...
              <div class="mb-1 col-12">
                <label for="direccion" class="form-label">pequeña descripcion</label>
                <input 
                  type="text"
                  id="direccion"
                  name="descripcion"
